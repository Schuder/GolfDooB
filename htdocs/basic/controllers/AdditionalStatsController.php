...
use app\models\SearchAdditionalStats;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * AdditionalStatsController implements the CRUD actions for AdditonalStats model.
 */
class AdditionalStatsController extends Controller
{
    ...
    {
        $searchModel = new SearchAdditionalStats();
